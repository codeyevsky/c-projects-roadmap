# The C Projects Roadmap — 660 Real Projects

A curated, non-filler collection of C projects that gradually increases in difficulty and covers the full breadth of systems programming. Each project is buildable in C, teaches something concrete, and is worth putting in a portfolio.

**Difficulty legend:** Beginner (B) · Intermediate (I) · Advanced (A)
...
Difficulty: Beginner
Topics: recursion, iteration, overflow awareness
Estimated LOC: 130
Libraries: stdio.h
...
- **Beginners:** start in categories 1–9 (fundamentals through games/data structures) before touching systems-level work.
- **Intermediate:** categories 10–19 (OS, Linux, networking, concurrency, memory, graphics, crypto) build real systems chops.
- **Advanced:** categories 20–31 (reversing, databases, compilers, emulators, ML, dev tools) are portfolio centerpieces.
- Each numbered project is intended to be its own repository with a README, tests, and a Makefile.
- Projects deliberately build on each other (e.g. 049 BigInt → 417 RSA; 097 CSV → 550 SQL-on-files; 649 object store → 650 mini-git → 651 merge).

**Total: 660 unique projects across 31 categories.**
